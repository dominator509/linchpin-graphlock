...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `d1ec4edda5ae29efefe02a9d2c57502be8f84c32b68925e3f640876648ca6467`
...
| completion is non-empty | PASS | `"A patent claim is a patent filing that outlines a claim that an inventor seeks to protect a unique product or process fr"` |
...
| egress sampler observes connections (positive control, REQ-REL-002) | PASS | `observed=[0.0.0.0,127.0.0.1] live_calls=5/5` |
...
| core: user evidence persists to a device-local vault file (REQ-PLAT-002) | PASS | `C:\Users\domin\AppData\Local\LINCHPIN\linchpin-vault.db (49152)` |
| artifact digest unchanged across the run | PASS | `d1ec4edda5ae29ef -> d1ec4edda5ae29ef` |
