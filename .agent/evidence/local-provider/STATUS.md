...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `1b4e864949cc11ea9e1adabee65703144a764ad7a3834faccde14fc988ef7e58`
...
| completion is non-empty | PASS | `"A patent claim is a formal document that protects an invention by a company, allowing it to avoid being copied and sold "` |
...
| egress sampler started and polled (harness liveness, REQ-REL-002) | PASS | `ready=true heartbeats=1` |
| egress sampler observes connections (positive control, REQ-REL-002) | PASS | `observed=[0.0.0.0,127.0.0.1] live_calls=21 (minimum 5)` |
...
| artifact digest unchanged across the run | PASS | `1b4e864949cc11ea -> 1b4e864949cc11ea` |
