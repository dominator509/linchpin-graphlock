...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `c56620d787240548796cec0a6be8926ad1ed911b54825208a70ffb1b1ebbc1d4`
...
| completion is non-empty | PASS | `"A patent claim is a detailed statement of an invention, including its description, scope, and any related claims."` |
...
| a second, differently-phrased request also returns real output | PASS | `"CANARY-mu4b9gf7-9ce7st"` |
...
| egress sampler started and polled (harness liveness, REQ-REL-002) | PASS | `ready=true heartbeats=15` |
...
| artifact digest unchanged across the run | PASS | `c56620d787240548 -> c56620d787240548` |
