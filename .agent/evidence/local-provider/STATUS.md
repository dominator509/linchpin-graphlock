...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `cf773ffc345b856744469a0b16a8ef810bdd189b82783ff8e59565a926f91c06`
...
| completion is non-empty | PASS | `"A patent claim is a formal assertion of an invention's novelty and limitation, often requiring a significant amount of t"` |
...
| egress sampler started and polled (harness liveness, REQ-REL-002) | PASS | `ready=true heartbeats=4` |
...
| artifact digest unchanged across the run | PASS | `cf773ffc345b8567 -> cf773ffc345b8567` |
