...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `4022b801856a7d34b2d6c7ec965ab723f97f2215459b36b8e6b4075c25bb8411`
...
| completion is non-empty | PASS | `"A patent claim is a statement asserting the inventor's control over a new or previously patented invention, with the int"` |
...
| a second, differently-phrased request also returns real output | PASS | `"A patent is a legal monopoly."` |
...
| egress sampler observes connections (positive control, REQ-REL-002) | PASS | `observed=[0.0.0.0,127.0.0.1] live_calls=9 (minimum 5)` |
...
| artifact digest unchanged across the run | PASS | `4022b801856a7d34 -> 4022b801856a7d34` |
