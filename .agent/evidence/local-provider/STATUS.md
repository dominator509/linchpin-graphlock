...
Executable: `target/release/linchpin-desktop-e2e.exe` sha256 `e575676e1ba44e638d101e9c1a5302c5dc210ed74c593f98f47bf86393b33cdd`
...
| completion is non-empty | PASS | `"A patent claim is a legally-binding representation that a company or inventor can use to protect its new or innovative p"` |
...
| a second, differently-phrased request also returns real output | PASS | `"CANARY-mu3x61jh-2570l1"` |
...
| egress sampler started and polled (harness liveness, REQ-REL-002) | PASS | `ready=true heartbeats=10` |
| egress sampler observes connections (positive control, REQ-REL-002) | PASS | `observed=[0.0.0.0,127.0.0.1] live_calls=7 (minimum 5)` |
...
| artifact digest unchanged across the run | PASS | `e575676e1ba44e63 -> e575676e1ba44e63` |
