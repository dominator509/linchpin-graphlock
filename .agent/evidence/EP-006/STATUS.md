EP-006 Candidate Epoch: EP-006-candidate-001
Status: DONE_VERIFIED

## Execution Summary
- Implemented secret redaction and log sanitization in crates/crash_reporter.
- Enforced invariant INV-012: Every crash capsule/log passes redaction before export.
- Verified security redaction unit tests.
