...
- Wall clock: **20.05s**; throughput **99.76 events/s**
- Write latency: p50 30.94ms, p95 213.32ms, max 2965.15ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1389 (failures 0); backups 59 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 3, backups 0
- Peak working set: 18501632 bytes; vault 1286144 bytes (643 bytes/event)
