...
- Wall clock: **19.99s**; throughput **100.07 events/s**
- Write latency: p50 31.61ms, p95 232.16ms, max 2522.20ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1465 (failures 0); backups 61 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 0, backups 0
- Peak working set: 20516864 bytes; vault 1286144 bytes (643 bytes/event)
