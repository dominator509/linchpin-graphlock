...
- Wall clock: **17.89s**; throughput **111.79 events/s**
- Write latency: p50 18.05ms, p95 212.89ms, max 2445.64ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1627 (failures 0); backups 56 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 4, backups 1
- Peak working set: 19439616 bytes; vault 1286144 bytes (643 bytes/event)
