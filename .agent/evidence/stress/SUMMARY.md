...
- Wall clock: **23.69s**; throughput **84.42 events/s**
- Write latency: p50 30.52ms, p95 270.81ms, max 2611.95ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1648 (failures 0); backups 66 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 4, backups 1
- Peak working set: 20942848 bytes; vault 1290240 bytes (645 bytes/event)
