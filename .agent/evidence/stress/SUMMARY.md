...
- Wall clock: **47.66s**; throughput **41.96 events/s**
- Write latency: p50 48.37ms, p95 566.01ms, max 2152.62ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 965 (failures 0); backups 55 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 2, backups 0
- Peak working set: 18186240 bytes; vault 1282048 bytes (641 bytes/event)
