...
- Wall clock: **19.08s**; throughput **104.85 events/s**
- Write latency: p50 19.25ms, p95 269.78ms, max 2348.43ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1746 (failures 0); backups 60 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 0, backups 0
- Peak working set: 20996096 bytes; vault 1282048 bytes (641 bytes/event)
