...
- Wall clock: **20.11s**; throughput **99.46 events/s**
- Write latency: p50 37.15ms, p95 227.89ms, max 1803.37ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1106 (failures 0); backups 56 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 3, backups 0
- Peak working set: 19066880 bytes; vault 1282048 bytes (641 bytes/event)
