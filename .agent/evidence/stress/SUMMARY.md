...
- Wall clock: **18.48s**; throughput **108.24 events/s**
- Write latency: p50 22.28ms, p95 248.81ms, max 1784.98ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1523 (failures 0); backups 57 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 4, backups 1
- Peak working set: 21643264 bytes; vault 1286144 bytes (643 bytes/event)
