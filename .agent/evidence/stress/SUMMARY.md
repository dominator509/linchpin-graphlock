...
- Wall clock: **18.56s**; throughput **107.76 events/s**
- Write latency: p50 17.26ms, p95 263.29ms, max 1968.77ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1668 (failures 0); backups 56 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 3, backups 0
- Peak working set: 21061632 bytes; vault 1282048 bytes (641 bytes/event)
