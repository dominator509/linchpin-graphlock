...
- Wall clock: **22.32s**; throughput **89.60 events/s**
- Write latency: p50 30.28ms, p95 272.26ms, max 1565.64ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1600 (failures 0); backups 66 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 3, backups 0
- Peak working set: 19152896 bytes; vault 1286144 bytes (643 bytes/event)
