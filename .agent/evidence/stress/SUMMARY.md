...
- Wall clock: **22.51s**; throughput **88.85 events/s**
- Write latency: p50 54.81ms, p95 242.05ms, max 1560.13ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 943 (failures 0); backups 55 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 0, backups 0
- Peak working set: 17133568 bytes; vault 1286144 bytes (643 bytes/event)
