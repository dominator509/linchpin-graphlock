...
- Wall clock: **18.96s**; throughput **105.49 events/s**
- Write latency: p50 37.52ms, p95 203.41ms, max 1679.67ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1069 (failures 0); backups 52 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 4, backups 1
- Peak working set: 19333120 bytes; vault 1290240 bytes (645 bytes/event)
