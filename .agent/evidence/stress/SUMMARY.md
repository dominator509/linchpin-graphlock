...
- Wall clock: **18.09s**; throughput **110.54 events/s**
- Write latency: p50 18.72ms, p95 213.80ms, max 2592.53ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1622 (failures 0); backups 58 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 3, backups 0
- Peak working set: 19234816 bytes; vault 1290240 bytes (645 bytes/event)
