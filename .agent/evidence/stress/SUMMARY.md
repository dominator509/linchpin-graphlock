...
- Wall clock: **18.25s**; throughput **109.62 events/s**
- Write latency: p50 18.73ms, p95 237.33ms, max 2014.11ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1633 (failures 0); backups 58 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 1, backups 1
- Peak working set: 19259392 bytes; vault 1286144 bytes (643 bytes/event)
