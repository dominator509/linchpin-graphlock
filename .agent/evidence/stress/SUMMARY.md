...
- Wall clock: **21.13s**; throughput **94.65 events/s**
- Write latency: p50 31.00ms, p95 255.88ms, max 1577.57ms
- Submissions: 2000; recorded 2000, replays 0, failures 0 (of which reported busy/locked: 0); **events lost: 0**
- Ledger holds 2000 events; read-backs 1488 (failures 0); backups 61 (failures 0)
- Refusals before the vault file existed (product reporting an absent vault, not a concurrency defect): reads 4, backups 1
- Peak working set: 20520960 bytes; vault 1286144 bytes (643 bytes/event)
