...
- Candidate `1c7092c`, epoch `3265f8fa39d12757…` over 153 inputs
- Artifact: `target\release\bundle\msi\LINCHPIN_0.1.0_x64_en-US.msi` `a29cdb38c463594a…` with the installed executable bound to the package payload
